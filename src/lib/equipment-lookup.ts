...
export const equipmentToHeroLookup: { [key in EquipKey]: HeroKey | "GENERIC" } =
  {
    ...
    EQUIP_BLACK_PANTHER_SHURI_HARD_LIGHT_SHIELD: "BLACK_PANTHER_SHURI",
    EQUIP_BLACK_PANTHER_SHURI_SPEAR_OF_BASHENGA: "BLACK_PANTHER_SHURI",
    ...
    EQUIP_CAPTAIN_AMERICA_SAM_WILSON_CAPTAIN_AMERICAS_SHIELD: "CAPTAIN_AMERICA_SAM_WILSON",
    ...
    EQUIP_MAGNETO_AOA_MAGNETOS_HELMET: "MAGNETO_APOCALYPSE",
